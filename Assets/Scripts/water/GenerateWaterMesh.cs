...
/* Figures out how many vertices are needed on the water mesh
 * based on its size. builds the trianges needed and adds them
 * to an array. Uses a second array with coords of each vertex
 * in Vector3 format for water interactions
 */
